...
<!-- 侧边栏导航-->
      <nav id="sidebar" style="border-right:1px solid white; width:20%; background:url('../static/img/Left.png') no-repeat; height:610px">
        ...
        <ul class="list-unstyled">
          ...
          <li class="active"><a href="../page/chart_3.do">最热话题 </a></li>
      ...
      <div class="page-contents">
        <div class="page-header">
          <div class="container-fluid"">
            ...
            <div>
            <li  class="active" style="list-style: none; display: inline-block;margin-right: 60px;"><a href="../page/chart_3.do" style="text-decoration: none;"></a></li>
